...
class ModeloTaboa(QAbstractTableModel):
    def __init__(self, datos):
        """Inicializa el modelo de tabla con los datos proporcionados.

        :param datos: Los datos para inicializar el modelo de tabla.
        """
        super().__init__()
        self.datos = datos

    def rowCount(self, index):
        """Devuelve el número de filas en el modelo de tabla.

        :param index: El índice del modelo de tabla.
        :return: El número de filas en el modelo de tabla.
        """
        return len(self.datos)

    def columnCount(self, index):
        """Devuelve el número de columnas en el modelo de tabla.

        :param index: El índice del modelo de tabla.
        :return: El número de columnas en el modelo de tabla.
        """
        return len(self.datos[0])

    def data(self, index, role=Qt.ItemDataRole.DisplayRole):
        """Devuelve los datos en el índice dado del modelo de tabla.

        :param index: El índice del modelo de tabla.
        :param role: El rol de los datos (por defecto: DisplayRole).
        :return: Los datos en el índice dado del modelo de tabla.
        """
        if index.isValid():
    ...
    def setData(self, index, value, role):
        """Establece los datos en el índice dado del modelo de tabla con el valor proporcionado.

        :param index: El índice del modelo de tabla.
        :param value: El valor para establecer en el índice.
...
class FiestraPrincipal (QMainWindow):
    ...
    def on_btnEngadir_pressed(self):
        """Maneja el evento de pulsación del botón 'Engadir'.

        Establece el estado del formulario como 'Engadir', borra los campos del formulario,
        y deshabilita los botones de 'Engadir', 'Editar' y 'Borrar'.
    ...
    def on_btnEditar_pressed(self):
        """Maneja el evento de pulsación del botón 'Editar'.

        Si se ha seleccionado una fila, establece el estado del formulario como 'Editar',
        carga los campos del formulario con los datos de la fila seleccionada y
        deshabilita los botones de 'Engadir', 'Editar' y 'Borrar'.
    ...
    def on_btnBorrar_pressed(self):
        """Maneja el evento de pulsación del botón 'Borrar'.

        Si se ha seleccionado una fila, establece el estado del formulario como 'Borrar',
        carga los campos del formulario con los datos de la fila seleccionada y
        deshabilita los botones de 'Engadir', 'Editar' y 'Borrar'.
    ...
    def on_btnAceptar_pressed(self):
        """Maneja el evento de pulsación del botón 'Aceptar'.

        Si el estado es 'Engadir', inserta un nuevo registro en la base de datos con los
        datos del formulario. Si el estado es 'Borrar', elimina el registro seleccionado.
        Si el estado es 'Editar', actualiza el registro seleccionado con los datos del formulario.
    ...
    def on_btnCancelar_pressed(self):
        """Maneja el evento de pulsación del botón 'Cancelar'.

        Limpia la selección actual y habilita el botón 'Engadir'.
    ...
    def on_modelo_selectionChanged(self):
        """Maneja el cambio de selección en el modelo de tabla.

        Habilita los botones 'Engadir', 'Editar' y 'Borrar' si hay una selección válida.
    ...
    def cargarCamposDendeSeleccion(self):
        """Carga los campos del formulario con los datos de la fila seleccionada.
